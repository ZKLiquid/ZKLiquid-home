...
export default function SocialMediaComing() {
  return (
    <ul className="flex items-center justify-center mt-8 space-x-3 sm:mt-12 lg:justify-start lg:mt-0">
      <li>
        <a
          href="https://twitter.com/zkliquid"
          target="_blank"
          title="twitter"
          className="inline-flex items-center justify-center w-10 h-10 text-gray-100 transition-all duration-200 rounded-full bg-black  "
      ...
      <li>
        ...
        >
          <svg
            viewBox="0 0 16 16"
            className=" text-teal-400  h-[20px] "
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
          >
